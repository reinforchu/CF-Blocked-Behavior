  ...
  <div id="cf-wrapper">
    ...
    <div id="cf-error-details" class="cf-error-details-wrapper">
      <div class="cf-wrapper cf-header cf-error-overview">
        ...
        <h2 class="cf-subheadline"><span data-translate="unable_to_access">You are unable to access</span> <?php echo htmlspecialchars($_SERVER['SERVER_NAME'], ENT_QUOTES); ?></h2>
      </div><!-- /.header -->
...
were doing when this page came up and the Cloudflare Ray ID found at the
 bottom of this page.</p>
  ...
  <p class="text-13">
    <span class="cf-footer-item sm:block sm:mb-1">Cloudflare Ray ID: <strong class="font-semibold">80f3<?php echo htmlspecialchars(bin2hex(random_bytes(6)), ENT_QUOTES); ?></strong></span>
    <span class="cf-footer-separator sm:hidden">•</span>
    <span id="cf-footer-item-ip" class="cf-footer-item sm:block sm:mb-1">
      Your IP:
      <button type="button" id="cf-footer-ip-reveal" class="cf-footer-ip-reveal-btn">Click to reveal</button>
      <span class="hidden" id="cf-footer-ip"><?php echo htmlspecialchars($_SERVER["REMOTE_ADDR"], ENT_QUOTES); ?></span>
      <span class="cf-footer-separator sm:hidden">•</span>
    </span>
